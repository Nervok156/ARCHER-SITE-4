...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Background Image - Сделаем светлее */}
      <div 
        ...
        style={{ 
          ...
          filter: 'brightness(0.6) contrast(1.2) sepia(0.4) hue-rotate(-10deg) saturate(1.3)' // Светлее
        }}
      ></div>
      ...
      {/* Texture Overlays - Уменьшим opacity */}
      ...
      {/* Enhanced gradients - Сделаем светлее */}
      ...
      {/* Добавляем стили для анимаций прямо в компонент */}
      <style jsx global>{`
        @keyframes floatUp {
          0% {
