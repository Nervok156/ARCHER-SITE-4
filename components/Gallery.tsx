...
const GALLERY_IMAGES = [
  { id: 1, caption: 'Видение битвы при Хельмовой Пади' },
  { id: 2, caption: 'Стычка на переправе' },
  { id: 3, caption: 'Штурм крепости' },
  { id: 4, caption: 'Битва у стен Минас-Тирита' },
  { id: 5, caption: 'Схватка в лесу Фангорн' },
  { id: 6, caption: 'Осада Барад-Дура' },
  { id: 7, caption: 'Битва на Пеленнорских полях' },
  { id: 8, caption: 'Финальное противостояние' }
];
...
export const Gallery: React.FC = () => {
  ...
  return (
    <section id="gallery" className="py-16 bg-iron-900 border-y border-iron-800"> {/* Уменьшили py с 24 до 16 */}
      <div className="container mx-auto px-4">
        <SectionTitle title="Видения Битв" subtitle="Осколки Памяти" />

        <div className="relative max-w-4xl mx-auto"> {/* Уменьшили max-w с 7xl до 4xl */}
          {/* Ornamental Frame - уменьшили отступы */}
          <div className="relative p-1 md:p-2 bg-iron-800 shadow-xl rounded-sm transition-all duration-700 hover:shadow-[0_15px_40px_-8px_rgba(127,29,29,0.3)] hover:scale-[1.005] group">
            ...
            <div className="relative aspect-[16/9] bg-black overflow-hidden"> {/* Оставили aspect-video или можно aspect-[16/9] */}
              ...
              {GALLERY_IMAGES.map((image, index) => (
                ...
                >
                  <img 
                    ...
                    onError={(e) => {
                      console.error(`Не удалось загрузить изображение: images/${image.id}.jpg`);
              ...
              {/* Caption для текущего изображения - уменьшили */}
              <div 
          ...
          {/* Controls - уменьшили размеры стрелок */}
          <button 
            onClick={prevSlide}
          ...
          >
            <ChevronLeft size={40} strokeWidth={1} className="drop-shadow-lg group-hover:scale-110 transition-transform" /> {/* Уменьшили с 64 до 40 */}
          </button>
          ...
          >
            <ChevronRight size={40} strokeWidth={1} className="drop-shadow-lg group-hover:scale-110 transition-transform" /> {/* Уменьшили с 64 до 40 */}
          </button>

          {/* Dots - уменьшили отступы */}
          ...
          {/* Keyboard Navigation Hint - уменьшили текст */}
